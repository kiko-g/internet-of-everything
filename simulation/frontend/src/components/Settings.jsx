...
export default function Settings() {
  return (
    <div className="bg-slate-100 p-4 rounded-xl w-full space-y-2 mx-auto">
      <Collapsed open={false} color="slate" headline="General">
      ...
      <Collapsed open={false} color="slate" headline="Extra Settings">
        <BasicInput placeholder="Max Temperature (ºC)" />
        <BasicInput placeholder="Breakpoints (format TBD)" />
      </Collapsed>
      {/* <div className="grid grid-cols-2 space-x-2">
        <Collapsed color="slate" headline="Setting C">
          Settings
        </Collapsed>
        <Collapsed color="slate" headline="Setting D">
          Settings
        </Collapsed>
      </div> */}
